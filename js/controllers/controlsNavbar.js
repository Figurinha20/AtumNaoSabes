...
if (localStorage.cards) {
    ...
    const card5 = new Card("Inácio Bonito", "../img/A continuação do peixe-11.png","Especial","A mascote do site ´AtumNãoSabes?'. Esta carta é um recompensa pelo teu trabalho! Seja por jogar o Quiz ou por dar-nos sugestões esta carta prova que consegues sempre saber mais explorando e divertindo-te!","","")
    ...
    "","")
    const card7 = new Card("Sardinha", "http://4.bp.blogspot.com/-uzuZTYsX9ng/TjGzFAlKc7I/AAAAAAAAAWM/1SieW5_6XMQ/s1600/cardume_sardinha.jpg","Grande Azul","As sardinhas formam grupos grandes e coordenados para se protegerem de predadores. São pequenas mas velozes e dificeis de apanhar quando de põem muito juntinhas e se preparam para esquivar.",["https://www.youtube.com/watch?v=U16N1NXsifk"],["https://www.youtube.com/watch?v=5XjxF3eG0_A"])
